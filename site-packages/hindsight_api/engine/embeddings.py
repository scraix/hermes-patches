...
class OpenAIEmbeddings(Embeddings):
    ...
    MODEL_DIMENSIONS = {
        ...
        # Jina v3 is OpenAI-compatible and returns 1024-dim embeddings.
        # Knowing this avoids a startup probe call that can crash the whole
        # daemon when the Jina account is temporarily out of balance.
